...
public:
    ...
    void vector(float ve1, float ve2, float ve3, float ve4, float ve5, float ve6)
    {
        ...
        vm[1] = ve5;
        vm[2] = ve6;
        //cout << "\t\t\tÂåêòîð: " << "(" << vc[0] << "+" << "(" << vm[0] << ")" << "i" << "," << vc[1] << "+" << "(" << vm[1] << ")" << "i" << "," << vc[2] << "+" << "(" << vm[2] << ")" << "i" << ")" << "\n";
    }
    void print(float ve1, float ve2, float ve3, float ve4, float ve5, float ve6) {
        cout << "\t\t\tÂåêòîð: " << "(" << vc[0] << "+" << "(" << vm[0] << ")" << "i" << "," << vc[1] << "+" << "(" << vm[1] << ")" << "i" << "," << vc[2] << "+" << "(" << vm[2] << ")" << "i" << ")" << "\n";
    }
    void slogvector(complex <float> x, complex <float>Y)
    {
        ...
        cout << "\t\t\tÏîëó÷åííûé âåêòîð: " << endl;
        cout << "\t\t\tÏåðâûé ñèìâîë: " << "(" << slv1[0] << ")" << slv2[0] << ")" << "i" << "," << slv1[1] << "+" << slv2[1] << ")" << "i" << "," << slv1[2] << "+" << "(" << slv2[2] << ")" << "i" << ")" << "\n";
    }
    void slog(complex<float> x, complex <float> Y)
    {
        vuc1 = x.c + Y.c;
        vuc2 = x.m + Y.m;
        cout << "Ñëîæåíèå ðàâíî: " << vuc1 << "+" << "(" << vuc2 << ")" << "i" << "\n";
    }
